...
export default function App() {
  ...
  async function handleSubmit(event) {
    ...
    setOfferStatus({ state: "sending", message: "Submitting your confidential offer…" });
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.error || "Unable to submit your offer.");
      }

      form.reset();
      setOfferStatus({
        state: "success",
        message: `Offer received securely. Reference: ${result.reference}`,
      });
    } catch (error) {
      setOfferStatus({
        state: "error",
        message: error instanceof Error ? error.message : "Unable to submit your offer.",
      });
    }
  }
      ...
      <main id="top">
        ...
        <section className="acquisition" id="acquisition">
          ...
          <form className="inquiry-form" onSubmit={handleSubmit} data-reveal>
            ...
            <p className="form-note">Your offer is encrypted in transit and stored privately for owner review.</p>
